...
Toàn bộ nội dung GDD đã implement xong (core loop, 5 vũ khí, 15 fusion, 2 boss, meta progression Coin/Unlock/Permanent Upgrade, Achievement, Daily Challenge, Pickup ngẫu nhiên), trừ Weapon unlock riêng, Âm thanh và Art thật (đang dùng placeholder màu sắc) — 2 việc còn lại không phụ thuộc nhau, có thể làm theo thứ tự bất kỳ.
