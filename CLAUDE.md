...
Toàn bộ nội dung GDD + các tính năng bổ sung đã implement xong (core loop, 5 vũ khí, 15 fusion, 2 boss, meta progression Coin/Unlock/Permanent Upgrade, Achievement, Daily Challenge, Pickup ngẫu nhiên, Elite Enemy/Dark Soul, Max Level, Pause Menu, player damage feedback), trừ Weapon unlock riêng, Âm thanh và Art thật (đang dùng placeholder màu sắc) — Weapon unlock vẫn đang bị hoãn theo quyết định trước đó (chỉ tập trung Character + Permanent Upgrade), 2 việc còn lại không phụ thuộc nhau, có thể làm theo thứ tự bất kỳ.
